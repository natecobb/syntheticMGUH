...
code          		varchar(100),
description   		varchar(255),
base_encounter_cost	float(4), -- base_encounter_cost
cost				float(4), -- total_claim_cost
payer_coverage		float(4),
...
cost		  		float(4), -- base_cost
payer_coverage		float(4), -- payer_coverage
dispenses			int,
totalcost			float(4),
reasoncode   		varchar(100),
reasondescription   varchar(255)
...
lat						numeric,
lon						numeric,
healthcare_expenses	float(4),
healthcare_coverage float(4)
);
